...
> **Historical document**: 이 계획은 v0.4.0 구현 시점에 작성되었습니다. v0.4.1에서 resolve 패키지가 Go 제네릭으로 리팩토링되었으므로, 현재 코드 구조는 이 문서와 다릅니다. 현재 상태는 `docs/superpowers/specs/2026-03-29-v0.4.1-usability-design.md`를 참조하세요.
